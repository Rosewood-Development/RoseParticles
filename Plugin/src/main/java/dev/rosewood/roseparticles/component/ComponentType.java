...
public final class ComponentType<T> {
    ...
    public static final ComponentType<EmitterInitializationComponent> EMITTER_INITIALIZATION = create("minecraft:emitter_initialization", EmitterInitializationComponent::parse);
    public static final ComponentType<EmitterRateInstantComponent> EMITTER_RATE_INSTANT = create("minecraft:emitter_rate_instant", EmitterRateInstantComponent::parse);
    public static final ComponentType<EmitterRateSteadyComponent> EMITTER_RATE_STEADY = create("minecraft:emitter_rate_steady", EmitterRateSteadyComponent::parse);
    ...
    public static final ComponentType<EmitterLifetimeLoopingComponent> EMITTER_LIFETIME_LOOPING = create("minecraft:emitter_lifetime_looping", EmitterLifetimeLoopingComponent::parse);
    public static final ComponentType<EmitterLifetimeOnceComponent> EMITTER_LIFETIME_ONCE = create("minecraft:emitter_lifetime_once", EmitterLifetimeOnceComponent::parse);
    public static final ComponentType<EmitterLifetimeExpressionComponent> EMITTER_LIFETIME_EXPRESSION = create("minecraft:emitter_lifetime_expression", EmitterLifetimeExpressionComponent::parse);
    ...
    public static final ComponentType<EmitterShapePointComponent> EMITTER_SHAPE_POINT = create("minecraft:emitter_shape_point", EmitterShapePointComponent::parse);
    ...
    public static final ComponentType<ParticleInitialSpeedComponent> PARTICLE_INITIAL_SPEED = create("minecraft:particle_initial_speed", ParticleInitialSpeedComponent::parse);
    public static final ComponentType<ParticleInitialSpinComponent> PARTICLE_INITIAL_SPIN = create("minecraft:particle_initial_spin", ParticleInitialSpinComponent::parse);
    ...
    public static final ComponentType<ParticleMotionDynamicComponent> PARTICLE_MOTION_DYNAMIC = create("minecraft:particle_motion_dynamic", ParticleMotionDynamicComponent::parse);
    ...
    public static final ComponentType<ParticleAppearanceTintingComponent> PARTICLE_APPEARANCE_TINTING = create("minecraft:particle_appearance_tinting", ParticleAppearanceTintingComponent::parse);
    ...
    public static final ComponentType<ParticleLifetimeExpressionComponent> PARTICLE_LIFETIME_EXPRESSION = create("minecraft:particle_lifetime_expression", ParticleLifetimeExpressionComponent::parse);
