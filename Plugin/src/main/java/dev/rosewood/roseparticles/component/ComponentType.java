...
public final class ComponentType<T> {
    ...
    /** [X] */ public static final ComponentType<EmitterRateManualComponent> EMITTER_RATE_MANUAL = create("minecraft:emitter_rate_manual", EmitterRateManualComponent::parse);
    ...
    /** [X] */ public static final ComponentType<EmitterLifetimeEventsComponent> EMITTER_LIFETIME_EVENTS = create("minecraft:emitter_lifetime_events", EmitterLifetimeEventsComponent::parse);
    ...
    /** [X] */ public static final ComponentType<EmitterShapeSphereComponent> EMITTER_SHAPE_SPHERE = create("minecraft:emitter_shape_sphere", EmitterShapeSphereComponent::parse);
    /** [X] */ public static final ComponentType<EmitterShapeBoxComponent> EMITTER_SHAPE_BOX = create("minecraft:emitter_shape_box", EmitterShapeBoxComponent::parse);
    /** [X] */ public static final ComponentType<EmitterShapeCustomComponent> EMITTER_SHAPE_CUSTOM = create("minecraft:emitter_shape_custom", EmitterShapeCustomComponent::parse);
    /** [X] */ public static final ComponentType<EmitterShapeEntityAABBComponent> EMITTER_SHAPE_ENTITY_AABB = create("minecraft:emitter_shape_entity_aabb", EmitterShapeEntityAABBComponent::parse);
    ...
    /** [X] */ public static final ComponentType<ParticleInitializationComponent> PARTICLE_INITIALIZATION = create("minecraft:partial_initialization", ParticleInitializationComponent::parse);
    ...
    /** [X] */ public static final ComponentType<ParticleMotionParametricComponent> PARTICLE_MOTION_PARAMETRIC = create("minecraft:particle_motion_parametric", ParticleMotionParametricComponent::parse);
    ...
    /** [X] */ public static final ComponentType<ParticleLifetimeEventsComponent> PARTICLE_LIFETIME_EVENTS = create("minecraft:particle_lifetime_events", ParticleLifetimeEventsComponent::parse);
